...
ActualTargets<- c('miR-486-5p','miR-92a-3p','miR-451a')
...
```{r}
Remove<- c(ActualTargets, "miR-25-3p"  )
...
```{r}
resOrdered<- GetDEResults(dds)
#32 DE miRNAs- padj <0.05
#22 DE miRNAs- padj <0.01
...
CPMLog[grep("miR-25-3p", rownames(CPMLog)),11]<- "DE"
