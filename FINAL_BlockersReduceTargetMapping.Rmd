...
```{r}
#Title: PercentMapping_Basespace_MatureIsomirs_TechCollapsed_TargetFamilies

p<- ggplot(PercentMapToTargets, aes(y=PercentMapToTarget, x=Sample, fill=BlockerStatus))+
  geom_bar(stat="identity", position="dodge")+ 
  theme_classic()+
  ylab("Percent of reads mapping to target miRNAs or species in target families \n (allowing for mismatches at 5'/3' ends)")+
  xlab("")+
...
```{r}
#Title: PercentMapping_Basespace_MatureOnly_TechCollapsed_TargetFamilies
p<- ggplot(PercentMapToTargets, aes(y=PercentMapToTarget, x=Sample, fill=BlockerStatus))+
  geom_bar(stat="identity", position="dodge")+ 
  theme_classic()+
...
Mature and Isomirs
```{r}
#Plot: PercentMapping_Basespace_MatureIsomir_TechNotCollapsed_TargetFamilies
...
Only mature species:
```{r}
#Plot: PercentMapping_Basespace_MatureOnly_TechNotCollapsed_TargetFamilies
...
```{r}
#Title: PercentMapping_Basespace_MatureOnly_TechCollapsed_IndividualTargets
...
p<- ggplot(PercentMapToTargets, aes(y=PercentMapToTarget, x=ID, fill=BlockerStatus))+
  geom_bar(stat="identity", position="dodge")+ 
  theme_classic()+
  ylab("Percent of reads mapping to each target \n (perfect matches only)")+
  xlab("")+
  ylim (0,100)+
  scale_fill_manual("legend", values=c("Blocked"="firebrick3", "Unblocked"="turquoise3"))+
  ...
  theme(axis.text.y   = element_text(size=10, colour = "black"),
        axis.title.y  = element_text(size=12),
        axis.title.x  = element_text(size=14),
        panel.border = element_rect(colour = "black", fill=NA, size=2), strip.background = element_blank(),
        legend.title=element_blank(),
        legend.position = c(.1,.892),
        legend.background = element_rect(fill=NA, size=1, linetype="solid", color="black"),
        axis.text.x.bottom  =element_text(color="black", size=15),
...
```{r}
#Title: PercentMapping_Basespace_MatureIsomirs_TechCollapsed_IndividualTargets
...
Finally, visualize this change for all 4 samples from blocker to no blocker
```{r}
#Title: PercentMapping_CL_TechCollapsed_TargetFamilies
p<- ggplot(PercentMapToTargets, aes(y=PercentMapToTarget, x=ID, fill=BlockerStatus))+
  geom_bar(stat="identity", position="dodge")+ 
  theme_classic()+
  ylab("Percent of reads mapping to \n target miRNAs or miRNAs in target families")+
  xlab("")+
  ylim (0,100)+
  scale_fill_manual("legend", values=c("Blocked"="firebrick3", "Unblocked"="turquoise3"))+
  theme(axis.text.y   = element_text(size=10, colour = "black"),
...
```{r}
#Title: PercentMapping_CL_TechCollapsed_ActualTargets
p<- ggplot(PercentMapToTargets, aes(y=PercentMapToTarget, x=ID, fill=BlockerStatus))+
  geom_bar(stat="identity", position="dodge")+ 
  theme_classic()+
  ylab("Percent of reads mapping to \n target miRNAs or miRNAs in target families")+
...
```{r}
#Plot: PercentMapping_CL_TechNotCollapsed_ActualTargets
...
p<- ggplot(PercentMapToTargets, aes(y=PercentMapToTarget, x=ID, fill=BlockerStatus))+
  geom_bar(stat="identity", position="dodge")+ 
  theme_classic()+
  ylab("Percent of reads mapping to all target miRNAs")+
  xlab("")+
  ylim (0,100)+
  scale_fill_manual("legend", values=c("Blocked"="firebrick3", "Unblocked"="turquoise3"))+
  theme(axis.text.y   = element_text(size=10, colour = "black"),
...
```{r}
#Title: PercentMapping_CL_TechCollapsed_IndividualTargets
...
p<- ggplot(PercentMapToTargets, aes(y=PercentMapToTarget, x=ID, fill=BlockerStatus))+
  geom_bar(stat="identity", position="dodge")+ 
  theme_classic()+
  ylab("Percent of reads mapping to target miRNA")+
  xlab("")+
  ylim (0,100)+
  scale_fill_manual("legend", values=c("Blocked"="firebrick3", "Unblocked"="turquoise3"))+
  facet_wrap(~species,nrow=1)+
