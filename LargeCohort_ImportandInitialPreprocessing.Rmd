...
```{r}
unblocked_readwd<-"//Cifs2/rcdata$/Small_RNA/BaseSpace/"
...
```{r}
blocked_readwd<-"//Cifs2/rcdata$/COPD/miRNAseq/BaseSpace/"
...
wd<-"C:/Users/jjl71/Documents/Github/BlockerProject_Updated/"
...
#Subset unblocked to only keep with pheno ID found in blocked
blocked_phenoID<- pairedSamples[ pairedSamples$UniqueID%in% colnames(blocked_Counts),3]
unblocked_UniqueID<-pairedSamples[pairedSamples$phenoId %in% blocked_phenoID, 4]
unblocked_Counts<-unblocked_Counts[,colnames(unblocked_Counts) %in% unblocked_UniqueID]

#Subset raw counts to paired samples -75 total pairs
paired_unblocked<-unblocked_Counts
