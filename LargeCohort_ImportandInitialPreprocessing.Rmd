...
write.csv(unblocked_collapse, paste(wd, "LargeCohort_RawData_Unblocked.csv", sep=""))
write.csv(blocked_collapse, paste(wd, "LargeCohort_RawData_blocked.csv", sep=""))
```
...
wd<-"C:/Users/Jenna/Documents/BlockerProject/"
unblocked_collapse<-read.csv(paste(wd, "LargeCohort_RawData_Unblocked.csv"), row.names = "X")
